    ...
    <section>
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2 snap-x">
        {services.map((service) => (
          <div
            key={service.id}
            className="bg-dark-900/50 border border-dark-800/50 p-4 rounded-xl min-w-[200px] md:min-w-[240px] snap-start"
          >
            ...
            <div className="text-barber-400 font-semibold text-sm mt-3">
