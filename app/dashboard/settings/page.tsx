...
export default async function SettingsPage() {
  ...
  const { data: barbershop } = await supabase
    .from("barbershops")
    .select("id, name, slug, address, city, phone, wa_number, latitude, longitude, settings_json, logo_url, cover_image_url, about, wuzapi_user_id, wuzapi_token, wa_connected, wa_phone_number")
    .eq("owner_id", user.id)
    .single();
